...
from keras.layers import Dense, Input, concatenate, Dropout, Activation
...
class CGAN():
    ...
    def __init__(self,arguments,X,y):
        [self.rand_noise_dim, 
         ...
         self.optimizer, 
         self.learning_rate, 
         self.min_num_neurones] = arguments
    ...
    def dump_to_file(self,save_dir = "./log"):
        ...
        self.generator.save("./trained_generators/gen.keras")
